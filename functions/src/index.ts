...
app.get('/klanten', async (req: Request, res: Response) => {
  try {
...
app.post('/klanten', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
    const klantData = {
      ...req.body,
...
app.put('/klanten/:id', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
...
app.delete('/klanten/:id', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
    const klantId = req.params.id;
...
app.get('/facturen', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
    ...
    const facturen = snapshot.docs.map(doc => ({
      id: doc.id,
      ...doc.data()
    }));
...
app.post('/facturen', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
...
app.put('/facturen/:id', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
...
app.delete('/facturen/:id', async (req: Request, res: Response) => {
  try {
    const userId = (req as any).user.uid;
    const factuurId = req.params.id;
