# Handmatige Database Migratie

Omdat de automatische migratie niet volledig werkt, volg deze stappen:

## Stap 1: Ga naar Supabase Dashboard

1. Open https://supabase.com/dashboard
2. Ga naar je project: https://supabase.com/dashboard/project/bpgcfjrxtjcmjruhcngn
3. Klik op "SQL Editor" in de linker sidebar

## Stap 2: Voer de Migratie uit

Kopieer en plak de volgende SQL in de SQL Editor en klik "Run":
...
## Stap 3: Maak de Tabellen

Voer dit uit in een nieuwe query:
...
2. Je zou alle tabellen moeten zien: `user_profiles`, `klanten`, `facturen`, `projecten`, `offertes`, `transacties`, `appointments`, `ai_feedback`, `ai_knowledge`
3. Controleer dat RLS is ingeschakeld (groene shield icoon bij elke tabel)

## Volgende Stap

Als alle tabellen zijn aangemaakt, kun je de applicatie testen:

```bash
npm run dev
```

En ga naar http://localhost:3000 om te testen!