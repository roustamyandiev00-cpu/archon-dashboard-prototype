/*
 * Login Page - User authentication form with Firebase
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === "auth/user-not-found") {
        toast.error("Geen account gevonden met dit e-mailadres");
  ...
  const handleGithubLogin = async () => {
    try {
      ...
      await signInWithPopup(auth, provider);
      toast.success("Succesvol ingelogd met GitHub!");
      setLocation("/dashboard");
    } catch (error: any) {
  ...
  const handleAppleLogin = async () => {
    try {
      ...
      await signInWithPopup(auth, provider);
      toast.success("Succesvol ingelogd met Apple!");
      setLocation("/dashboard");
    } catch (error: any) {
      ...
      if (error.code === "auth/popup-closed-by-user") {
        ...
        toast.error("Er is een fout opgetreden bij Apple login");
      }
    }
  };
