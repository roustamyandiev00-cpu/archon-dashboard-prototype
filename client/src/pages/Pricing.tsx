...
export default function Pricing() {
  ...
  const plans = [
    {
      ...
      price: isYearly ? 23.20 : 29, // 29 * 0.8 = 23.2
      originalPrice: 29,
      features: [
    ...
    },
    {
      ...
      price: isYearly ? 63.20 : 79, // 79 * 0.8 = 63.2
      originalPrice: 79,
      features: [
    ...
    },
    {
      ...
      price: isYearly ? 159.20 : 199, // 199 * 0.8 = 159.2
      originalPrice: 199,
      features: [
  ...
  const handleSubscribe = (planId: string) => {
    if (planId === "enterprise") {
      toast.info("Contactaanvraag verstuurd", {
        description: "Onze accountmanager neemt binnen 24u contact met je op."
      });
      return;
    }

    toast.success(`Abonnement ${planId} geselecteerd`, {
      description: "Je wordt doorgestuurd naar de SEPA incasso pagina. Eerste 14 dagen gratis!",
      action: {
        label: "Ga door",
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-white/10 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <h3 className="text-xl font-bold">Start vandaag nog zonder risico</h3>
          <p className="text-muted-foreground max-w-2xl">
            Kies je plan en betaal via automatische incasso (domiciliëring). De eerste 14 dagen zijn volledig gratis. 
            Je kunt op elk moment opzeggen binnen de proefperiode zonder kosten.
          </p>
          <div className="flex gap-4 mt-2 text-sm text-muted-foreground">
            <span className="flex items-center gap-1"><CreditCard className="w-4 h-4" /> Veilig via SEPA</span>
